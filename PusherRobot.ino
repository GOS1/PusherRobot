...
int xStepsPerRevolution=800; //motor's rated # steps per one revolution
int yStepsPerRevolution=800;
...
void loop() {
  if (currentState == SEARCH) {
      ...
      int numSteps = distanceToGo/distancePerRevolution*xStepsPerRevolution;
      ...
      Serial.println("Reached the position. Finding new position. Changing the state now. ");
...
//     }
      ...
      delay(2000);
      Serial.print("Moving backward now");
      yStepper.move(-ySteps);
      yStepper.runToPosition();
